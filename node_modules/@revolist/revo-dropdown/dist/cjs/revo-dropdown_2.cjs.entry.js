...
const index = require('./index-df285776.js');
...
const RevoDropdownStyle0 = revoDropdownStyleCss;
...
const RevoDropdown = class {
    ...
    renderDropdown() {
        return (index.h("div", { class: "revo-dropdown-list", ref: e => (this.dropdown = e) }, index.h("div", { [UUID]: this.uuid, class: "dropdown-inner", ref: e => (this.dropdownInner = e) }, this.hasFilter && !this.autocomplete ? (index.h(DropdownListFilter, { ref: e => (this.dropdownInput = e), source: this.source, filter: this.filter, dataLabel: this.dataLabel, value: this.currentFilter || '', filterValue: this.currentFilter || '', onFilterChange: e => {
            ...
            } })) : undefined, index.h("revo-list", { ref: e => (this.revoList = e), isFocused: true, selectedIndex: this.getValueIndex(this.value), sourceItems: this.currentSource, onChanged: e => this.doChange(e.detail.item, e.detail.e), template: item => (this.template ? this.template(index.h, item) : getItemLabel(item, this.dataLabel)) }))));
    }
    renderSelect() {
...
RevoDropdown.style = RevoDropdownStyle0;
...
const RevoDropdownList = class {
    ...
    render() {
        ...
        for (let i in this.sourceItems) {
            ...
            const li = index.h("li", Object.assign({ key: 'cb47c8bde7b1a4229675c49daad83816e03e1461' }, props), this.template(item));
            items.push(li);
        }
        return index.h("ul", { key: '3a77f6a7bb446d5f380b4f4e774906f59d36e31f' }, items);
    }
    static get watchers() { return {
        "selectedIndex": ["valueChanged"]
    }; }
};
RevoDropdownList.style = RevoListStyle0;

exports.revo_dropdown = RevoDropdown;
exports.revo_list = RevoDropdownList;

//# sourceMappingURL=revo-dropdown_2.cjs.entry.js.map