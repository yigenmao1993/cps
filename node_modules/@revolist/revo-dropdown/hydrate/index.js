...
const BUILD = /* revo-dropdown */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: false, cmpDidRender: true, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: true, constructableCSS: false, cssAnnotations: true, devTools: false, disconnectedCallback: true, element: false, event: true, experimentalScopedSlotChanges: false, experimentalSlotFixes: false, formAssociated: false, hasRenderFn: true, hostListener: true, hostListenerTarget: true, hostListenerTargetBody: false, hostListenerTargetDocument: true, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, hydratedSelectorName: "hydrated", invisiblePrehydration: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: true, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: true, propMutable: true, propNumber: true, propString: true, reflect: false, scoped: false, scopedSlotTextContentFix: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: false, shadowDomShim: true, slot: false, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: true, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: true, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: true, watchCallback: true };
...
const DropdownListFilter = (p) => {
    ...
    return (hAsync("input", Object.assign({ class: { 'filter-box': true, }, type: "text" }, p, { onClick: e => {
            e.preventDefault();
...
const ArrowRenderer = () => {
    return (hAsync("span", { class: "arrow-wrapper" },
        hAsync("svg", { class: "arrow", "aria-hidden": "true", focusable: "false", role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 320 512" },
            hAsync("path", { fill: "currentColor", d: "M41 288h238c21.4 0 32.1 25.9 17 41L177 448c-9.4 9.4-24.6 9.4-33.9 0L24 329c-15.1-15.1-4.4-41 17-41z" }))));
};
...
var RevoDropdownStyle0 = revoDropdownStyleCss;
...
class RevoDropdown {
    ...
    renderDropdown() {
        return (hAsync("div", { class: "revo-dropdown-list", ref: e => (this.dropdown = e) }, hAsync("div", { [UUID]: this.uuid, class: "dropdown-inner", ref: e => (this.dropdownInner = e) }, this.hasFilter && !this.autocomplete ? (hAsync(DropdownListFilter, { ref: e => (this.dropdownInput = e), source: this.source, filter: this.filter, dataLabel: this.dataLabel, value: this.currentFilter || '', filterValue: this.currentFilter || '', onFilterChange: e => {
                var _a;
                this.currentFilter = e.value;
                this.currentSource = e.items;
                (_a = this.revoList) === null || _a === void 0 ? void 0 : _a.refresh(this.currentSource);
            } })) : undefined, hAsync("revo-list", { ref: e => (this.revoList = e), isFocused: true, selectedIndex: this.getValueIndex(this.value), sourceItems: this.currentSource, onChanged: e => this.doChange(e.detail.item, e.detail.e), template: item => (this.template ? this.template(hAsync, item) : getItemLabel(item, this.dataLabel)) }))));
    }
    renderSelect() {
        const val = (this.currentItem && getItemLabel(this.currentItem, this.dataLabel)) || '';
        return hAsync("input", { type: "text", disabled: true, class: "filter-box", value: val });
    }
    renderAutocomplete() {
        const val = this.currentItem ? getItemLabel(this.currentItem, this.dataLabel) : '';
        return (hAsync(DropdownListFilter, { ref: e => (this.autocompleteInput = e), autocomplete: "true", source: this.source, filter: this.filter, dataLabel: this.dataLabel, value: val, filterValue: this.currentFilter, onKeyDown: e => {
                if (this.isVisible) {
                    return;
                }
                switch (e.code) {
    ...
    render() {
        ...
        return (hAsync(Host, Object.assign({ key: 'c76b30c10b5d5727112a1912be87324b54af9c57' }, props), hAsync("label", { key: 'a7bb046d9863866d356c2b61c5af5402d96dd260' }, this.placeholder), hAsync("div", { key: '7c04280ed41bae735b82346e2f96ca0a980b3a58', class: "rv-dr-root" }, this.autocomplete ? this.renderAutocomplete() : this.renderSelect(), hAsync("span", { key: '1ba2e9d1d18c3e9f3fece999d6fc7bbf8fb4947f', class: "actions" }, hAsync(ArrowRenderer, { key: '2249cb5299f24011e47fe38ea36afe3effba3c94' })), hAsync("fieldset", { key: '1ad14cb273cfd420aaf6c847b950e780f748c63c' }, hAsync("legend", { key: 'cc3810362cb47b96c56487ee833de6bc90a594e8' }, hAsync("span", { key: '4bfccee1d4e13fda7eadf428c250ae58f30f9d2e' }, this.placeholder)))), list));
    }
    showAutoComplete() {
    ...
    static get style() { return RevoDropdownStyle0; }
    static get cmpMeta() { return {
        "$flags$": 0,
        "$tagName$": "revo-dropdown",
        "$members$": {
        ...
        "$listeners$": [[5, "mousedown", "onMouseUp"], [4, "keydown", "onKey"]],
        "$lazyBundleId$": "-",
        "$attrsToReflect$": []
    }; }
}
...
var RevoListStyle0 = revoListStyleCss;

class RevoDropdownList {
    constructor(hostRef) {
        registerInstance(this, hostRef);
    ...
    render() {
        ...
        for (let i in this.sourceItems) {
            ...
            const li = hAsync("li", Object.assign({ key: 'cb47c8bde7b1a4229675c49daad83816e03e1461' }, props), this.template(item));
            items.push(li);
        }
        return hAsync("ul", { key: '3a77f6a7bb446d5f380b4f4e774906f59d36e31f' }, items);
    }
    static get watchers() { return {
